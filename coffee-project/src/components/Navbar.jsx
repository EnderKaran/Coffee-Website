    ...
    return ( 
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-20 left-0 w-full bg-zinc-900/95 flex flex-col items-center space-y-6 py-8">
          <a href="#" className="text-lg uppercase text-white">About Us</a>
          <a href="#" className="text-lg uppercase text-white">We Offer</a>
          <a href="#" className="text-lg uppercase text-white">Why Us</a>
          <a href="#" className="text-lg uppercase text-white">Testimonials</a>
